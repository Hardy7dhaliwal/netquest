...
import { LAB_TEMPLATES_EXTRA6 } from "./lab-templates-extra6";
import { LAB_TEMPLATES_EXTRA7 } from "./lab-templates-extra7";
...
export const LAB_TEMPLATES: LabTemplate[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        acceptedCommands: (variant) => [`switchport trunk allowed vlan add ${variant.values!.vlan}`],
    ...
    steps: [
      {
        ...
        commands: (variant) => ["show access-lists", "show ip access-lists", `show ip interface ${variant.values!.iface.toLowerCase().replace(/gigabitethernet/, "gi")}`],
        output: (variant) =>
      ...
      },
      {
        ...
        acceptedCommands: (variant) => [`ip access-group ${variant.values!.acl} in`],
      ...
      },
      {
        ...
        commands: (variant) => [`show ip interface ${variant.values!.iface.toLowerCase().replace(/gigabitethernet/, "gi")}`, "show access-lists"],
        output: (variant) =>
  ...
  ...LAB_TEMPLATES_EXTRA6,
  ...LAB_TEMPLATES_EXTRA7,
];
